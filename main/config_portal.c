...
static esp_err_t config_get_handler(httpd_req_t *req)
{
    ...
    n += snprintf(buf + n, sizeof(buf) - n,
        "],\"t_rise\":%d,\"t_fall\":%d}", t_rise_ms, t_fall_ms);
